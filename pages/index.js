...
export default function Home() {
    return (
        <div className={styles.container}>
                ...
                <div className="row mt-3" align="center">
                    <div className="col-md-12 col-sm-12">
                        <img
                            ...
                            src="https://digitvl.org/wp-content/uploads/2022/04/Digitvl-Logo-Transparent-01-300x169.png"
                            alt="digitvl logo"/>
                    </div>
                </div>
                <div className="row mt-5" align="center">
                    <div className="col-md-6 col-sm-12 my-auto">
                        <div className="row" align="center">
                            <div className="col-md-12">
                                <span className="custom-text1">The Future Is</span>
                            </div>
                        </div>
                        <div className="row" align="center">
                            <div className="col-md-12 col-sm-12">
                        ...
                        <div className="row" align="center">
                            <div className="col-md-12">
                                <span className="custom-text2">This era, the creators will have true independence with Web 3.0</span>
                            </div>
                        </div>
                    </div>
            ...
            <div className="row">
                <div className="col-md-12 col-sm-12" align="center">
                    <span className="custom-heading-section1"><b>Our Mission</b></span>
                </div>
                <div className="col-md-6 col-sm-12" align="right">
                    <div className="row">
                        <div className="col-md-12 col-sm-12">
